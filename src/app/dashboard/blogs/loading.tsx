    ...
    <div className="space-y-5 w-full px-1 py-3">
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between">
        <div className="flex gap-2 flex-1 max-w-lg">
          ...
          <Skeleton className="h-9 w-40 bg-muted animate-pulse rounded-md" />
        </div>
      ...
      <div className="rounded-xl border border-border overflow-hidden">
        <div className="bg-muted/30 px-4 py-3 border-b border-border flex items-center gap-4">
          <Skeleton className="h-4 w-4 bg-muted animate-pulse rounded" />
          <Skeleton className="h-4 w-40 bg-muted animate-pulse" />
          <Skeleton className="h-4 w-24 bg-muted animate-pulse ml-auto hidden md:block" />
        ...
        <div className="divide-y divide-border">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="px-4 py-4 flex items-center gap-4">
              <Skeleton className="h-4 w-4 bg-muted animate-pulse rounded shrink-0" />
