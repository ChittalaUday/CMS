...
export function EditorialEditor({
  ...
  const handleFormSubmit = async () => {
    ...
    try {
      ...
      toast.success(
        initialData ? "Post saved successfully" : "Post published successfully",
      );
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            {canPublish && initialData?.slug && (
              <Button
                ...
                size="sm"
                onClick={() =>
                  window.open(`/posts/${initialData.slug}`, "_blank")
                }
        ...
        <div className="flex flex-col md:flex-row flex-1 min-h-0 bg-background/50">
              ...
              >
                ...
                >
                  <SheetHeader>
                    ...
                    <SheetDescription>
                      Manage categories, tags, and publication state.
                    </SheetDescription>
                  </SheetHeader>
                  <div className="space-y-6 p-4">
                    <div className="space-y-2">
                      ...
                      <div className="relative flex items-center">
                        <span className="absolute left-3 text-xs text-muted-foreground/60 font-medium">
                          /posts/
                        </span>
                        <Input
                          id="slug-input"
                    ...
                    <div className="border-t border-border pt-4 space-y-3">
                      <div className="flex items-center justify-between py-1 px-1">
                        <Label
                          ...
                          className="cursor-pointer text-xs font-semibold text-muted-foreground uppercase"
                        >
          ...
          <main className="flex-1 bg-card/10 flex flex-row min-h-0 relative">
            ...
            <div className="flex-1 overflow-y-auto px-4 md:px-12 py-6 md:py-16 flex justify-center">
              <div
                className="max-w-2xl w-full space-y-6 flex flex-col relative"
            ...
            <aside className="w-80 border-l border-border bg-card flex flex-col p-6 overflow-y-auto shrink-0 select-none space-y-6 rounded-xl my-8 mr-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Configure metadata and categorization.
                </p>
              </div>
